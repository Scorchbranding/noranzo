    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-gold/30 bg-navy p-3 shadow-2xl">
      <div className="flex items-center gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-xs text-ivory/60 line-through">${siteConfig.offer.regularPrice}</p>
        ...
        <a
          ...
          className="cta-pulse flex shrink-0 items-center gap-1.5 rounded-md bg-gold px-5 py-3 text-sm font-bold uppercase text-navy"
        >
          Get Access
